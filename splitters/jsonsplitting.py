...
docs= loader.load()
json_docs= (docs[0].page_content)
data= json.loads(json_docs)    #change string that loooks like dict into type dict
print(data)
print(type(data))
json_splitter= RecursiveJsonSplitter(max_chunk_size= 1000)
splitted_json= json_splitter.split_json(data, convert_lists= True)
print(splitted_json)
